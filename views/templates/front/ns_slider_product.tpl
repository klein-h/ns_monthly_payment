...
<div>
    ...
    <div class="card-block">
        <div class="cart-summary-line" id="cart-subtotal-products" style="text-align: center">
            <a class="label js-subtotal" id="total" style="font-size: 26px; color: black; font-weight: 600;">
...
<div class="checkout card-block" style="width: 100%">
    <div class="text-sm-center">
        <form action="{$ns_page_link|escape:'html'}" method="post">
            ...
            <input hidden value="{$ns_page_id}" name="id_product">
